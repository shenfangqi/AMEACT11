(function($) {
   ...
   $.fn.sfqTouchSlider = function(options){
              ...
              var thisHeight = options.t_height;
              var contentHeight = parseInt($this.children("lay").css("height"));


              //if(contentHeight < 400)  //should be same as options->t_height
              //      return;
	          ...
	          div.id = "sfq-bar";
	          div.style.zIndex = 0;
	          //div.style.left = "10px";      //must be this css width - 10
	          div.style.top = "0px";
	          div.style.width = "15px";
	          div.style.height = "0px";
	          div.style.backgroundColor = "#f4154d";
              ...
              function startMoveEventFunction(e) {
                  contentHeight = parseInt($this.children("lay").css("height"));
...
//$("#info").val(map_height +":"+ thisLen);
   ...
   $.fn.sfqTouchSlider.horizon = function(width,height){
              $("nav").css("top","10px");
              $("nav").css("width",width+"px");
              $("nav").css("height",height+"px");
              $("#sfq-bar").css("left",(width-10)+"px"); 
   };
   
   $.fn.sfqTouchSlider.vertical = function(width,height){
              $("nav").css("top","20px");
              $("nav").css("width",width+"px");
              $("nav").css("height",height+"px");
              $("#sfq-bar").css("left",(width-10)+"px"); 
   ...
   $.fn.sfqTouchSlider.bar_h6 = function(width){
	          $("nav").css('width',width + "px");              
			  $("#sfq-bar").css("left",(width-34)+"px"); 
