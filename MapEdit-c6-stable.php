...
<div id="dialog-inventory" title="My inventory" style="z-index:1">
	<p>Please select an item and move it to the target position ,right click on it to allocate the selected item  to the map.</p>
...
for($i=0;$i<count($useritems);$i++)  {
    ...
    echo "<img id='".$itemID."' src='".$tar_img_file."' style='width:$width;height:$height' onclick=setSelectedItem(this.id,".$imgoff_str.",'".$sub_items_str."','".$loc_str."')>";
}
?>
</div>
...
function setSelectedItem(imgcode,off,sub_item,sub_loc)  {
