...
function bodyPos() {
   ...
   this.pos_arr_dn["lLeg"]["bx_off"]=13;   //baseX: value is the offset from canvas origin postion
   this.pos_arr_dn["lLeg"]["by_off"]=83;
   this.pos_arr_dn["lLeg"]["rx_off"]=8;    //rotateX: value is the offset from baseX,use for rotation
   this.pos_arr_dn["lLeg"]["ry_off"]=4;

   this.pos_arr_dn["lArm"]["bx_off"]=-1;
   this.pos_arr_dn["lArm"]["by_off"]=74;
   this.pos_arr_dn["lArm"]["rx_off"]=14;
   this.pos_arr_dn["lArm"]["ry_off"]=0;

   this.pos_arr_dn["lLimb"]["bx_off"]=11;
   this.pos_arr_dn["lLimb"]["by_off"]=65;
   this.pos_arr_dn["lLimb"]["rx_off"]=14;
   this.pos_arr_dn["lLimb"]["ry_off"]=0;

   this.pos_arr_dn["body"]["bx_off"]=16;
   this.pos_arr_dn["body"]["by_off"]=62;
   this.pos_arr_dn["body"]["rx_off"]=12;
   this.pos_arr_dn["body"]["ry_off"]=0;

   this.pos_arr_dn["rLeg"]["bx_off"]=24;
   this.pos_arr_dn["rLeg"]["by_off"]=88;
   this.pos_arr_dn["rLeg"]["rx_off"]=8;
   this.pos_arr_dn["rLeg"]["ry_off"]=0;

   this.pos_arr_dn["rArm"]["bx_off"]=42;
   this.pos_arr_dn["rArm"]["by_off"]=74;
   this.pos_arr_dn["rArm"]["rx_off"]=0;
   this.pos_arr_dn["rArm"]["ry_off"]=0;

   this.pos_arr_dn["rLimb"]["bx_off"]=32;
   this.pos_arr_dn["rLimb"]["by_off"]=65;
   this.pos_arr_dn["rLimb"]["rx_off"]=0;
   this.pos_arr_dn["rLimb"]["ry_off"]=0;
   ...
   this.pos_arr_up["lLeg"]["bx_off"]=14;   //baseX: value is the offset from canvas origin postion
   this.pos_arr_up["lLeg"]["by_off"]=87;
   this.pos_arr_up["lLeg"]["rx_off"]=8;    //rotateX: value is the offset from baseX,use for rotation
   this.pos_arr_up["lLeg"]["ry_off"]=4;

   this.pos_arr_up["lArm"]["bx_off"]=1;
   this.pos_arr_up["lArm"]["by_off"]=72;
   this.pos_arr_up["lArm"]["rx_off"]=14;
   this.pos_arr_up["lArm"]["ry_off"]=0;

   this.pos_arr_up["lLimb"]["bx_off"]=12;
   this.pos_arr_up["lLimb"]["by_off"]=63;
   this.pos_arr_up["lLimb"]["rx_off"]=14;
   this.pos_arr_up["lLimb"]["ry_off"]=0;

   this.pos_arr_up["body"]["bx_off"]=16;
   this.pos_arr_up["body"]["by_off"]=62;
   this.pos_arr_up["body"]["rx_off"]=12;
   this.pos_arr_up["body"]["ry_off"]=0;

   this.pos_arr_up["rLeg"]["bx_off"]=24;
   this.pos_arr_up["rLeg"]["by_off"]=82;
   this.pos_arr_up["rLeg"]["rx_off"]=8;
   this.pos_arr_up["rLeg"]["ry_off"]=4;

   this.pos_arr_up["rArm"]["bx_off"]=39;
   this.pos_arr_up["rArm"]["by_off"]=71;
   this.pos_arr_up["rArm"]["rx_off"]=0;
   this.pos_arr_up["rArm"]["ry_off"]=0;

   this.pos_arr_up["rLimb"]["bx_off"]=30;
   this.pos_arr_up["rLimb"]["by_off"]=62;
   this.pos_arr_up["rLimb"]["rx_off"]=0;
   this.pos_arr_up["rLimb"]["ry_off"]=0;

   this.pos_arr_up["head"]["bx_off"]=0;
   this.pos_arr_up["head"]["by_off"]=0;
...
function human(orient,inistr) {
    ...
    this.overlap_order_dn = [0,1,2,4,3,5,6,7];
...
function addItem(itemStr)  {
     ...
     if(isItemInIni(itemStr,inistr))  {
            inistr = removeItem(itemStr);
            return inistr;
     }
     ...
     for(var i=0;i<t1.length;i++) {
        ...
        inistr = setItem(bodyID,itemID,offsetStr);
     }
...
function removeItem(itemStr) {
     ...
     for(var i=0;i<t1.length;i++) {
          ...
          inistr = unsetItem(bodyID,itemID);
     }
...
function getAttachmentList(inistr)   {
     var t1 = inistr.split("||");
     var t2,t3;
     var list = [];
...
function isItemInIni(itemstr,inistr) {
     var t1 = getItemAttachement(itemstr);
     var t2 = getAttachmentList(inistr);
