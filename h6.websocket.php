...
<body style="background-color:#4f4f4f;margin-top: 0px;margin-left: 0px;" onscroll="relocateSaydiv()" onorientationchange="ajustOrientation(event);">
...
<div id="sayDiv" style="z-index:2;left:96px;top:62px;position: absolute;display:none">
     <table border=0>
     <tr>
...
var anistr = "&&35;102;0;ld_37;79;0;ld_28;86;0;ld_40;77;0;ld_46;100;0;ld_56;80;0;ld_60;85;0;ld_20;20;0;ld&&35;102;-40;ld_37;83;20;ld_28;84;30;ld_40;77;0;ld_46;100;20;ld_56;80;-20;ld_60;83;-20;ld_20;20;0;ld&&35;102;20;ld_37;79;0;ld_28;84;10;ld_40;77;0;ld_46;98;-20;ld_54;76;10;ld_58;85;10;ld_20;20;0;ld";
var or = "ld";
var hm = new human(or,inistr_main);
hm.animator(anistr);
//hm.setHMPos(150,120);  //设置human显示到跟canvas圆点的相对位置。 50，120为基点，表示为蓝色的点
...
//  var socket = io.connect('http://180.37.144.138:3000');
...
//$("#sayText").val("mm:"+isScrMoving);
               ...
               if(isScrMoving==0) {
                   ...
                   if(target_pos<0) {
                      ...
                      target_pos = 0;
                   } else if(jQuery.inArray(target_pos,map_mark)==-1) {
                       mainsprite.setPath();
                   } else {
...
$("#sayBut").click(function() {
     ...
     if(content !="") {
        ...
        $.ajax({type:"GET", url:"sendChatMsg.php?from="+fr+"&to="+to+"&content="+content, dataType:"text",async:false,success:function (msg){
           //if(isActContent(unescape(content))) {
           //   mainsprite.setActStr(unescape(content));
...
$("#A1").click(function() {
     ...
     var fr = user;
     var to="";
     var content = "&&35;102;0;ld_37;79;20;ld_32;82;40;ld_36;77;-10;ld_46;100;0;ld_52;76;40;ld_52;85;90;ld_18;18;-10;ld&&35;102;0;ld_37;79;20;ld_32;82;30;ld_36;77;-10;ld_46;100;0;ld_54;76;50;ld_50;85;120;ld_18;18;-10;ld&&35;102;0;ld_37;79;20;ld_32;82;40;ld_36;77;-10;ld_46;100;0;ld_54;76;50;ld_50;85;100;ld_18;18;-10;ld&&35;102;0;ld_37;79;20;ld_32;82;30;ld_36;77;-10;ld_46;100;0;ld_54;76;50;ld_50;85;120;ld_18;18;-10;ld&&35;102;0;ld_37;79;0;ld_28;86;0;ld_40;77;0;ld_46;100;0;ld_56;80;0;ld_60;85;0;ld_20;20;0;ld";

     $.ajax({type:"GET", url:"sendChatMsg.php?from="+fr+"&to="+to+"&content="+escape(content), dataType:"text",async:false,success:function (msg){
...
$("#A2").click(function() {
     ...
     var fr = user;
     var to="";
     var content = "&&33;96;-10;ld_31;73;70;ld_22;70;90;ld_34;69;0;ld_40;90;-20;ld_52;76;-70;ld_56;73;-50;ld_18;12;10;ld&&35;102;0;ld_37;79;0;ld_28;86;0;ld_40;77;0;ld_46;100;0;ld_56;80;0;ld_60;85;0;ld_20;20;0;ld&&33;96;-10;ld_31;73;70;ld_22;70;90;ld_34;69;0;ld_40;90;-20;ld_52;76;-70;ld_56;73;-50;ld_18;12;10;ld&&35;102;0;ld_37;79;0;ld_28;86;0;ld_40;77;0;ld_46;100;0;ld_56;80;0;ld_60;85;0;ld_20;20;0;ld";
...
//根据设备调整canvas方向
//由于调查不全，现在做法为将html和脚本中中canvas的宽高都固定。
//最后解决方案应该为，为不同方向制定不同的宽高设定，否则将物体绘制在屏幕显示不出来的canvas位置上造成浪费
//具体方法可能为，1，利用css适配将canvas，2，利用下面脚本设定相关参数
function ajustOrientation() {
           ...
           //临时固定尺寸
           cb_canvas.width=2048;
           cb_canvas.height=1024;
           bg_width=2048;
           bg_height=1024;
...
function openConnection() {
    ...
    if (conn.readyState === undefined || conn.readyState > 1) {
        conn = new WebSocket('ws://180.37.144.138:8001');
