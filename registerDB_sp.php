...
<table width="408" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <th scope="col"><a href="./" target="_top"><img src="./images/title1.png" width="819" height="154"></th>
  </tr>
  <tr>
...
<tr>
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="60" align="right" bgcolor="#D51875"><font face="Arial" size=5 color="#FFFFFF">Boy:<input type=radio id="gender" name="gender" value="1" checked style="width:40px;height:40px"></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td align="left" bgcolor="#D51875"><font face="Arial" size=5 color="#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Girl:<input type=radio id="gender" name="gender" value="2"  style="width:40px;height:40px"></font></td>
      </tr>
      <tr>
        <td height="60" align="right" bgcolor="#D51875"><font face="Arial" size=5 color="#FFFFFF">User ID:&nbsp;</font></td>
        <td align="left" bgcolor="#D51875"><input id="uname" name="uname" maxlength=8 type="text" style="width:170px;height:50px;font-size: 30px;"></td>
      </tr>
      <tr>
        <td align="right" bgcolor="#D51875"  height="60"><font face="Arial" size=5 color="#FFFFFF">Display Name:&nbsp;</font></td>
        <td align="left" bgcolor="#D51875"><input id="unick" name="unick" type=text maxlength=6  style="width:170px;height:50px;font-size: 30px;"><input id="unickescape" name="unickescape" type=hidden></td>
      </tr>
      <tr>
        <td align="right" bgcolor="#D51875"  height="60"><font face="Arial" size=5 color="#FFFFFF">Password:&nbsp;</font></td>
        <td align="left" bgcolor="#D51875"><input id="upass" name="upass" type=password style="width:170px;height:50px;font-size: 30px;"></td>
      </tr>
      <tr>
        <td align="right" bgcolor="#D51875"  height="60"><font face="Arial" size=5 color="#FFFFFF">Password (Confirm):&nbsp;</font></td>
        <td align="left" bgcolor="#D51875"><input  id="reupass" name="reupass" type=password style="width:170px;height:50px;font-size: 30px;"></td>
      </tr>
    </table>
</form>
