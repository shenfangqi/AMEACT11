		                   ...
		                   // if not smartphone
                                   if(isBrowser) { 
                                       ...
                                       if($('#map').css("width") !="undefined")  {
                                         ...
                                         $("#returnCtrl").css("top", (bg_height+22)+"px");
                                         $("#applyCtrl").css("top", (bg_height+22)+"px");
		                               } 
		                           
/*
                                       if($('#canvas').css("width") !="undefined")  {
		                                var lw = getWidth();   //10 is the original double border width
		                                var lh = getHeight()-150;
